...
static int sampling_delay = 100000; // in microseconds
...
void run_sampling(pid_t child_pid, Node* n, const std::vector<std::string>& events) {
    int rv;
    int status;
...
int main(int argc, char *argv[]) {
    ...
    //execute application sampling
    //note: this function will wait child to be terminated
    run_sampling(child_pid, n, events);
